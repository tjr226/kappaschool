  ...
  return knex('cards').del()
    .then(function () {
      ...
      return knex('cards').insert([
        ...
        {id: 6, question: 'ham', answer: 'ham', lecture_segment_id: 2},
        ...
        {id: 10, question: 'fan', answer: 'fan', lecture_segment_id: 3},
        {id: 11, question: 'pan', answer: 'pan', lecture_segment_id: 3},
        {id: 12, question: 'Dan', answer: 'Dan', lecture_segment_id: 3},
        ...
        {id: 16, question: 'bag', answer: 'bag', lecture_segment_id: 4},
        {id: 17, question: 'rag', answer: 'rag', lecture_segment_id: 4},
        ...
        {id: 29, question: 'mass', answer: 'mass', lecture_segment_id: 5}
      ]);
    });
};
